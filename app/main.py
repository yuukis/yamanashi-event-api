...
async def read_events(response: Response, background_tasks: BackgroundTasks,
                      keyword: str = None):
...
async def read_events_today(response: Response,
...
async def read_events_full(response: Response,
                           background_tasks: BackgroundTasks,
                           keyword: str = None):
...
async def read_events_full_today(response: Response,
                                 background_tasks: BackgroundTasks,
                                 keyword: str = None):
...
def get_events_from_cache(cache, params):
    json, last_modified = cache.get_with_last_modified(params)
    if json is not None:
