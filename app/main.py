...
async def lifespan(app: FastAPI):
    await asyncio.to_thread(service.preload_archive_indexes)
    yield


app = FastAPI(
    title=service.config["metadata"]["title"],
    description=service.config["metadata"]["description"],
    version=service.config["metadata"]["version"],
    lifespan=lifespan
)
